...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // ID
      char dummy1[sizeof (leviathan::IDToken *)];

      // INTLITERAL
      char dummy2[sizeof (leviathan::IntLitToken *)];

      // STRINGLITERAL
      char dummy3[sizeof (leviathan::StrToken *)];
      ...
      // VOID
      // WHILE
      char dummy4[sizeof (leviathan::Token *)];
    };
...
switch (yykind)
    ...
    Parser (leviathan::Scanner &scanner_yyarg);
    virtual ~Parser ();
